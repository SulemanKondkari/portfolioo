    ...
    <div className="relative min-h-screen bg-background selection:bg-red-500/10 selection:text-red-600">
      ...
      <main>
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-7xl mx-auto">
          ...
          <h1 
            className="animate-fade-rise text-6xl sm:text-8xl md:text-9xl leading-[0.95] tracking-[-3.46px] font-bold font-display uppercase text-white"
          >
          ...
          <p className="animate-fade-rise-delay text-red-600 text-xl sm:text-2xl md:text-3xl max-w-4xl mt-12 leading-tight font-bold font-body italic opacity-90">
            <span className="text-white">The official portfolio of </span> Suleman Kondkari, <span className="text-neutral-400">specializing in high-performance digital architecture and </span> cinematic UX.
          </p>

          <div className="animate-fade-rise-delay-2 mt-20">
            <button className="liquid-glass rounded-full px-14 py-5 text-base text-white bg-red-600/10 border-red-600/20 hover:scale-[1.03] transition-transform cursor-pointer font-bold backdrop-blur-md uppercase tracking-widest">
              Begin Journey
            </button>
          </div>
        </div>
