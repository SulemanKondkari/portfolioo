      ...
      <main>
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-7xl mx-auto">
          ...
          <p className="animate-fade-rise-delay text-red-600 text-xl sm:text-2xl md:text-3xl max-w-4xl mt-12 leading-tight font-bold font-body italic opacity-90">
            <span className="text-white md:text-black">The official portfolio of </span> Suleman Kondkari, <span className="text-neutral-400 md:text-black/70">specializing in high-performance digital architecture and </span> cinematic UX.
          </p>
