...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Automation Redefined</span> <span className="text-red-600/60">✦</span>
      ...
      >
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-black text-white cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            <h2
              ref={headingRef}
              className="text-5xl md:text-8xl font-black text-red-600 tracking-tighter mb-12 text-center"
            >
              Ready to begin?
            </h2>
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton as="a" href="/temp-mail-agent.zip" className="footer-glass-pill px-10 py-5 rounded-full text-white font-bold text-sm md:text-base flex items-center gap-3 group">
                  <svg className="w-6 h-6 text-neutral-500 group-hover:text-red-500 transition-colors" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                <MagneticButton as="a" href="/temp-mail-agent-report.pdf" target="_blank" className="footer-glass-pill px-6 py-3 rounded-full text-neutral-400 font-medium text-xs md:text-sm hover:text-red-500">
                  Agent Report
                </MagneticButton>
                <MagneticButton as="a" href="/temp-mail-agent-report.pdf" target="_blank" className="footer-glass-pill px-6 py-3 rounded-full text-neutral-400 font-medium text-xs md:text-sm hover:text-red-500">
                  Technical Docs
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-neutral-500 text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 Suleman. All rights reserved.
            </div>
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-white/10">
              ...
              <span className="text-white font-black text-xs md:text-sm tracking-normal ml-1">Suleman</span>
            </div>

            <MagneticButton
              as="button"
              onClick={scrollToTop}
              className="w-12 h-12 rounded-full footer-glass-pill flex items-center justify-center text-neutral-500 hover:text-red-500 group order-3"
            >
